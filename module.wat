(module
  ...
  (export "Max" (func $Max))
  (func $PrintContainer (param $container i32) (param $element i32) 
    (local $tmp_sq f32)
    (local $int_i i32)
    (local $int_h f32)
    (local $int_sum f32)
  ...
  (export "PrintContainer" (func $PrintContainer))
  (func $GetDefault  (result i32)
    (local $tmp_sq f32)
    (local $int_i i32)
    (local $int_h f32)
    (local $int_sum f32)
  ...
  (export "GetDefault" (func $GetDefault))
